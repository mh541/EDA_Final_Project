...
SDG.anova.CO2<-aov(data=SDG_Data.short, CO2 ~ Country)
summary(SDG.anova.CO2)

SDG.anova.CO2.2<-lm(data=SDG_Data.short, CO2 ~ Country)
summary(SDG.anova.CO2.2)

plot(SDG.anova.CO2.2)
